...
//获得任务列表
router.get('/getMissionData', validationMiddleware, controllers.getMissionData)

//获得任务详细
router.get('/getMissionDetail', validationMiddleware, controllers.getMissionDetail)
